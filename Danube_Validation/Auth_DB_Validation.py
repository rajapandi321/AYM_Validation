...
if __name__ == "__main__":
    V1_config = {
        'dbname': os.getenv('dbname4'),
        'user': os.getenv('user4'),
        'password': os.getenv('password4'),
        'host': os.getenv('host4'),
        'port': os.getenv('port4')  # Fixed the key for port1
    }
    ...
    validation_results.to_csv('D:/DB_Results/auth_db.csv', index=False)
